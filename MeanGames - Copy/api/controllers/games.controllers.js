...
const getAll = function (req, res) {
    ...
    if (response.status != 200) {
        ...
        Game.find().skip(offset).limit(count).exec((err, games) => _getAllGames(err, games, response, res));
    }
...
const getOne = function (req, res) {
    ...
    if (response.status != 200) {
        ...
        Game.findById(gameId).exec((err, games) => _findGameById(err, games, response, res));
    }
...
const partialUpdate = function (req, res) {
    console.log("Partial Update Game Controller");
       partialGameUpdate = function (req, res, game, response) {
        ...
        game.publisher.country     = req.body.publisher.country     ||  game.publisher.country    ;
        game.publisher.established = req.body.publisher.established ||  game.publisher.established;
        game.publisher.location    = req.body.publisher.location    ||  game.publisher.location   ;
